...
const Products = ({addProductToBasket, handleCheckout}) => {
  ...
  return (
        ...
        <div className="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a>
                    ...
                    <p className="pt-1 text-gray-900">£3.99</p>
                    <button onClick={()=>addProductToBasket({
                        "product_id":"1",
                        "product_title": "Tea Cup",
                        "price": "£3.99",
                        "product_link": "https://images.unsplash.com/photo-1555982105-d25af4182e4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80",
                        "quantity": 1
                    })} className='p-2 bg-gray-300 rounded-md mt-2'>Add To Basket</button>
                </a>
            </div>
            ...
            <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a>
                    ...
                    <div className="pt-3 flex items-center justify-between">
                        <p className="">Camera Lens</p>
                        <svg className="h-6 w-6 fill-current text-gray-500 hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path d="M12,4.595c-1.104-1.006-2.512-1.558-3.996-1.558c-1.578,0-3.072,0.623-4.213,1.758c-2.353,2.363-2.352,6.059,0.002,8.412 l7.332,7.332c0.17,0.299,0.498,0.492,0.875,0.492c0.322,0,0.609-0.163,0.792-0.409l7.415-7.415 c2.354-2.354,2.354-6.049-0.002-8.416c-1.137-1.131-2.631-1.754-4.209-1.754C14.513,3.037,13.104,3.589,12,4.595z M18.791,6.205 c1.563,1.571,1.564,4.025,0.002,5.588L12,18.586l-6.793-6.793C3.645,10.23,3.646,7.776,5.205,6.209 c0.76-0.756,1.754-1.172,2.799-1.172s2.035,0.416,2.789,1.17l0.5,0.5c0.391,0.391,1.023,0.391,1.414,0l0.5-0.5 C14.719,4.698,17.281,4.702,18.791,6.205z" />
                        </svg>
                    </div>
                    <p className="pt-1 text-gray-900">£79.99</p>
                    <button onClick={()=>addProductToBasket({
                        "product_id":"2",
                        "product_title": "Camera Lens",
                        "price": "£79.99",
                        "product_link": "https://images.unsplash.com/photo-1508423134147-addf71308178?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80",
                        "quantity": 1
                    })} className='p-2 bg-gray-300 rounded-md mt-2'>Add To Basket</button>
                </a>
            </div>
            ...
            <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a>
                    ...
                    <p className="pt-1 text-gray-900">£109.99</p>
                    <button onClick={()=>addProductToBasket({
                        "product_id":"3",
                        "product_title": "Desk",
                        "price": "£109.99",
                        "product_link": "https://images.unsplash.com/photo-1449247709967-d4461a6a6103?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80",
                        "quantity": 1
                    })} className='p-2 bg-gray-300 rounded-md mt-2'>Add To Basket</button>
                </a>
            </div>
            ...
            <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a>
                    ...
                    <p className="pt-1 text-gray-900">£49.99</p>
                    <button onClick={()=>addProductToBasket({
                        "product_id":"4",
                        "product_title": "Typewriter",
                        "price": "£49.99",
                        "product_link": "https://images.unsplash.com/reserve/LJIZlzHgQ7WPSh5KVTCB_Typewriter.jpg?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80",
                        "quantity": 1
                    })} className='p-2 bg-gray-300 rounded-md mt-2'>Add To Basket</button>
                </a>
            </div>
            ...
            <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a>
                    ...
                    <div className="pt-3 flex items-center justify-between">
                        <p className="">Steel Cup</p>
                        <svg className="h-6 w-6 fill-current text-gray-500 hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path d="M12,4.595c-1.104-1.006-2.512-1.558-3.996-1.558c-1.578,0-3.072,0.623-4.213,1.758c-2.353,2.363-2.352,6.059,0.002,8.412 l7.332,7.332c0.17,0.299,0.498,0.492,0.875,0.492c0.322,0,0.609-0.163,0.792-0.409l7.415-7.415 c2.354-2.354,2.354-6.049-0.002-8.416c-1.137-1.131-2.631-1.754-4.209-1.754C14.513,3.037,13.104,3.589,12,4.595z M18.791,6.205 c1.563,1.571,1.564,4.025,0.002,5.588L12,18.586l-6.793-6.793C3.645,10.23,3.646,7.776,5.205,6.209 c0.76-0.756,1.754-1.172,2.799-1.172s2.035,0.416,2.789,1.17l0.5,0.5c0.391,0.391,1.023,0.391,1.414,0l0.5-0.5 C14.719,4.698,17.281,4.702,18.791,6.205z" />
                        </svg>
                    </div>
                    <p className="pt-1 text-gray-900">£1.99</p>
                    <button onClick={()=>addProductToBasket({
                        "product_id":"5",
                        "product_title": "Steel Cup",
                        "price": "£1.99",
                        "product_link": "https://images.unsplash.com/photo-1467949576168-6ce8e2df4e13?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80",
                        "quantity": 1
                    })} className='p-2 bg-gray-300 rounded-md mt-2'>Add To Basket</button>
                </a>
            </div>
            ...
            <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a>
                    ...
                    <div className="pt-3 flex items-center justify-between">
                        <p className="">Wooden Tea Cup Mat</p>
                        <svg className="h-6 w-6 fill-current text-gray-500 hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path d="M12,4.595c-1.104-1.006-2.512-1.558-3.996-1.558c-1.578,0-3.072,0.623-4.213,1.758c-2.353,2.363-2.352,6.059,0.002,8.412 l7.332,7.332c0.17,0.299,0.498,0.492,0.875,0.492c0.322,0,0.609-0.163,0.792-0.409l7.415-7.415 c2.354-2.354,2.354-6.049-0.002-8.416c-1.137-1.131-2.631-1.754-4.209-1.754C14.513,3.037,13.104,3.589,12,4.595z M18.791,6.205 c1.563,1.571,1.564,4.025,0.002,5.588L12,18.586l-6.793-6.793C3.645,10.23,3.646,7.776,5.205,6.209 c0.76-0.756,1.754-1.172,2.799-1.172s2.035,0.416,2.789,1.17l0.5,0.5c0.391,0.391,1.023,0.391,1.414,0l0.5-0.5 C14.719,4.698,17.281,4.702,18.791,6.205z" />
                        </svg>
                    </div>
                    <p className="pt-1 text-gray-900">£5.99</p>
                    <button onClick={()=>addProductToBasket({
                        "product_id":"6",
                        "product_title": "Wooden Tea Cup Mat",
                        "price": "£5.99",
                        "product_link": "https://images.unsplash.com/photo-1544787219-7f47ccb76574?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80",
                        "quantity": 1
                    })} className='p-2 bg-gray-300 rounded-md mt-2'>Add To Basket</button>
                </a>
            </div>
            ...
            <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a>
                    ...
                    <button onClick={()=>addProductToBasket({
                        "product_id":"7",
                        "product_title": "Statue",
                        "price": "£9.99",
                        "product_link": "https://images.unsplash.com/photo-1550837368-6594235de85c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80",
                        "quantity": 1
                    })} className='p-2 bg-gray-300 rounded-md mt-2'>Add To Basket</button>
                </a>
            </div>
            <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a>
                    ...
                    <div className="pt-3 flex items-center justify-between">
                        <p className="">Red Dice Pair</p>
                        <svg className="h-6 w-6 fill-current text-gray-500 hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path d="M12,4.595c-1.104-1.006-2.512-1.558-3.996-1.558c-1.578,0-3.072,0.623-4.213,1.758c-2.353,2.363-2.352,6.059,0.002,8.412 l7.332,7.332c0.17,0.299,0.498,0.492,0.875,0.492c0.322,0,0.609-0.163,0.792-0.409l7.415-7.415 c2.354-2.354,2.354-6.049-0.002-8.416c-1.137-1.131-2.631-1.754-4.209-1.754C14.513,3.037,13.104,3.589,12,4.595z M18.791,6.205 c1.563,1.571,1.564,4.025,0.002,5.588L12,18.586l-6.793-6.793C3.645,10.23,3.646,7.776,5.205,6.209 c0.76-0.756,1.754-1.172,2.799-1.172s2.035,0.416,2.789,1.17l0.5,0.5c0.391,0.391,1.023,0.391,1.414,0l0.5-0.5 C14.719,4.698,17.281,4.702,18.791,6.205z" />
                        </svg>
                    </div>
                    <p className="pt-1 text-gray-900">£2.99</p>
                    <button onClick={()=>addProductToBasket({
                        "product_id":"8",
                        "product_title": "Red Dice Pair",
                        "price": "£2.99",
                        "product_link": "https://images.unsplash.com/photo-1551431009-a802eeec77b1?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&h=400&q=80",
                        "quantity": 1
                    })} className='p-2 bg-gray-300 rounded-md mt-2'>Add To Basket</button>
                </a>
            </div>
    ...
    <div className='flex flex-wrap justify-center'>
        <button onClick={()=>handleCheckout()} className='bg-gray-500 rounded-md p-3 text-white'>Checkout</button>
    </div>
    <section className="bg-white py-8">
