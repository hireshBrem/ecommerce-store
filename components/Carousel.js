...
const Carousel = () => {
  return (
    <>
    {/* <div className="carousel relative container mx-auto max-width-[1600px]">
        <div className="carousel-inner relative overflow-hidden w-full">
            ...
            <div className="carousel-item absolute opacity-0">
                <div className="block h-full w-full mx-auto pt-6 md:pt-0 md:items-center bg-cover bg-right bg-pic1">
            ...
            <div className="carousel-item absolute opacity-0 bg-cover bg-right">
                <div className="block h-full w-full mx-auto pt-6 md:pt-0 md:items-center bg-cover bg-right">
            ...
            <div className="carousel-item absolute opacity-0">
                <div className="block h-full w-full mx-auto pt-6 md:pt-0 md:items-center bg-cover bg-bottom bg-[url('https://images.unsplash.com/photo-1533090161767-e6ffed986c88?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjM0MTM2fQ&auto=format&fit=crop&w=1600&q=80')]">
    ...
    <section className="w-full mx-auto bg-nordic-gray-light flex pt-12 md:pt-0 md:items-center bg-cover bg-right max-w-[1600px] h-[32rem] bg-[url('https://images.unsplash.com/photo-1422190441165-ec2956dc9ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1600&q=80')]">
